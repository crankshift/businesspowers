---
name: business-pl-opening-jdg-checklist
...
# business-pl-opening-jdg-checklist
...
|---|---|---|
| ZUS reżimy (ulga na start, mały, duży), chorobowa 2,45% | `business-pl-calculating-zus` | → patrz skill _(01.01.2026)_ |
| VAT limit zwolnienia 200 000 zł (art. 113) | `business-pl-vat-agent` | 200 000 zł _(01.01.2026)_ |
| Formy opodatkowania (skala/liniowy/ryczałt) | `business-pl-calculating-pit-scale`, `business-pl-calculating-pit-liniowy`, `business-pl-calculating-ryczalt` | → patrz skille _(01.01.2026)_ |
...
Skill: `business-pl-pkd-codes-reference`.

### Wybór formy opodatkowania

Skill: `business-pl-choosing-tax-form` lub agent: `business-pl-tax-form-advisor`.
...
Skill: `business-pl-calculating-zus` lub agent: `business-pl-zus-agent`.
