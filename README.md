...
A collection of jurisdiction-specific business & tax plugins for **Claude Code**. Each plugin wraps a set of subagents and skills tuned to one country's tax system, registration procedures, reporting requirements, and the day-to-day headaches of running as a sole trader or declaring taxes as an individual.
...
- **No liability.** To the maximum extent permitted by law, neither Anthropic (the provider of Claude), nor the authors, maintainers, or contributors of this repository, will be liable for any direct, indirect, incidental, consequential, special, or exemplary damages arising from the use of, or inability to use, this software — including but not limited to damages from incorrect calculations, missed filing deadlines, under- or over-payment of tax, penalties, interest, fines, or any other financial or administrative consequence. You use these plugins entirely at your own risk.
