---
name: business-pl-invoice-analyzer
...
# Agent: business-pl-invoice-analyzer
...
**Poza zakresem:**
- Wystawianie nowych faktur — `business-pl-invoice-manager`.
- Kalkulacje PIT / VAT — `business-pl-jdg-tax-calculator`, `business-pl-vat-agent`.
...
|---|---|---|
| VAT stawki 23/8/5/0%, MPP 15 000 zł, biała lista | `business-pl-vat-agent` | 23% / 8% / 5% / 0%; 15 000 zł _(01.01.2026)_ |
