...
**Poza zakresem:**
- Kalkulacja PIT — `business-pl-jdg-tax-calculator`.
- Podatkowe aspekty składki zdrowotnej w rozliczeniu rocznym — `business-pl-calculating-skladka-zdrowotna`.
...
|---|---|---|
| ZUS stawki (19.52/8/2.45/1.67%), podstawy wymiaru, reżimy, MZ, przeciętne wynagrodzenie | `business-pl-calculating-zus` | → patrz skill _(01.01.2026)_ |
