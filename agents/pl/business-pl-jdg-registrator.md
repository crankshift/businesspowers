---
name: business-pl-jdg-registrator
...
# Agent: business-pl-jdg-registrator
...
**Poza zakresem:**
- Kalkulacja konkretnych kwot PIT / ZUS — `business-pl-jdg-tax-calculator`.
- Porównanie form — `business-pl-tax-form-advisor`.
- Sprawozdawczość po rejestracji — `business-pl-jdg-reporting-agent`.
- Zamknięcie JDG — `business-pl-jdg-closer`.
...
|---|---|---|
| VAT stawki 23/8/5/0%, zwolnienie podmiotowe 200 000 zł | `business-pl-vat-agent` | 200 000 zł _(01.01.2026)_ |
| ZUS reżimy, stawki, podstawy wymiaru | `business-pl-calculating-zus` | → patrz skill _(01.01.2026)_ |
...
Skill `business-pl-pkd-codes-reference` — typowe kody.
...
Skill / agent: `business-pl-tax-form-advisor` / `business-pl-choosing-tax-form`.
...
Skill: `business-pl-calculating-zus`.
