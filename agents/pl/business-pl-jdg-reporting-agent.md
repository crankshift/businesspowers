---
name: business-pl-jdg-reporting-agent
...
# Agent: business-pl-jdg-reporting-agent
...
**Poza zakresem:**
- Kalkulacja kwot — `business-pl-jdg-tax-calculator`, skille `calculating-*`.
- Rejestracja / zamknięcie — `business-pl-jdg-registrator` / `business-pl-jdg-closer`.
- PIT-38 osoby fizycznej — `business-pl-kapitalowe-investments-agent`.
...
|---|---|---|
| Terminy, kary KKS, odsetki za zwłokę, stopa redyskonta NBP | `business-pl-reporting-deadlines-pl` | → patrz skill _(01.01.2026)_ |
