---
name: business-pl-tax-form-advisor
...
# Agent: business-pl-tax-form-advisor
...
**Poza zakresem:**
- Sama rejestracja JDG — `business-pl-jdg-registrator`.
- Kalkulacja konkretnych kwot — `business-pl-jdg-tax-calculator` + skille `calculating-*`.
...
|---|---|---|
| Skala 12%/32%, kwota wolna 30 000 zł, ulga na dziecko | `business-pl-calculating-pit-scale` | 12% / 32%; 30 000 zł _(01.01.2026)_ |
...
Przekazać skillom `calculating-pit-*`, `business-pl-calculating-zus`, `business-pl-calculating-skladka-zdrowotna`.
