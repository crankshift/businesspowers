---
name: business-pl-kapitalowe-investments-agent
...
# Agent: business-pl-kapitalowe-investments-agent
...
- Ogólne podatki osoby fizycznej (spadek, nieruchomość) — `business-pl-osoba-fizyczna-tax-advisor`.
...
|---|---|---|
| Stawka 19% od kapitałów (art. 30b), dywidendy 19% (art. 30a), przenoszenie strat 50%/5 lat | `business-pl-calculating-pit-38` | 19%; 50% / 5 lat _(01.01.2026)_ |
...
Skill: `business-pl-converting-currency-nbp`.
